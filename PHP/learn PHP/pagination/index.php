...
<body>
    <div class="container">
        ...
        <div class="row" id="search_result_output">
            <?php
    ...
    <nav aria-label="Page navigation example">
        ...
        <ul class="pagination">
            ...
            ?>
                        <li class="page-item">
                            <a class="page-link pagination_item" href="?page=<?=$i?>" ><?= $i ?></a>
                        </li>
                    <?php }
                } else { ?>
                    <strong>
...
<script>
    if ('<?= $first_page ?>' == 1) {$('#prev').addClass('disabled')}
    if ('<?= $last_page ?>' == 1) {$('#next').addClass('disabled')}

    $('#search').on('input propertychnage', function() {
        $.ajax({
            url: 'search.php',
            type: 'post',
            dataType: 'text',
            ...
            success: function(response) {
                $('#search_result_output').html(response)
            }
        })
    })
